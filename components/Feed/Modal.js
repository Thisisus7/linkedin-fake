...
const Modal = ({ handleClose, type }) => {  // close modal, modal type
    ...
    <Backdrop onClick={handleClose}>
      {type === "dropIn" && (
        <motion.div
          ...
          className="rounded-xl flex flex-col justify-center bg-white dark:bg-[#1D2226] w-full max-w-lg md:-mt-10 mx-6"
          variants={dropIn}
          initial="hidden"
          animate="visible"
          exit="exit"
